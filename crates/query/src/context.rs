...
///
/// **P3A — minimal.** Only `scope_vector` is consumed. P6A adds
/// `rolling_vec` and the pin-precedence chain via the existing
/// `effective_vec()` plumbing; P9b-min adds the two-phase
